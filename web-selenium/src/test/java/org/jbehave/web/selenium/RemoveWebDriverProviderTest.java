...
public class RemoveWebDriverProviderTest {
    ...
    public void shouldFailUponInitializeDueToMissingURL() throws Throwable {
        MyPerStoriesWebDriverSteps steps = new MyPerStoriesWebDriverSteps(new RemoteWebDriverProvider());
